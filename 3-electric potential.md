...
The electric field due to the (point) charge q would be $\frac{kq}{R^2} \hat{R}$ , R being the magnitude of the position vector joining the unit charges and the source charge, pointing radially outwards. The electric field and the displacement vectors have opposite directions, which is exatly why the negative sign exists: the dot product of $\vec{E}$ and $-d\vec{R}$ simply becomes the product of magnitudes of vectors $\vec{E}$ and $-d\vec{R}$. Therefore, the above integral becomes- 
